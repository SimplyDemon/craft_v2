...
class IndexController extends Controller
{
    ...
    public function index()
    {
        ...
        $faq['Всё сам сделал?'] = '<b>Да</b>. Сервис был создан с нуля одним человеком. Спасибо всем за фидбек и ваши предложения, всегда открыт к ним! Отдельно благодарю за помощь <b>Стурн</b> - помог создать парсер скринов и цену можно выгружать в полуавтоматическом режиме.';
