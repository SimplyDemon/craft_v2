...
function seederAddRecipe(
    ...
    string $masterworkName = null,
    int $count = 1,
    bool $isResource = false,
    string $keywords = null,
    int $lvl = null,
    int $crystalsCount = null,
    int $saLvl = null,
    string $saGemCount = null,
    string $saRedName = null,
    string $saGreenName = null,
    string $saBlueName = null,
    string $saRedDescription = null,
    string $saGreenDescription = null,
    string $saBlueDescription = null,
    bool $isMage = false,
    ...
    return Recipe::create([
        ...
        'm_attack' => $attackMagic,
        'p_attack' => $attackPhysic,
        'm_def' => $defenceMagic,
        'p_def' => $defencePhysic,
