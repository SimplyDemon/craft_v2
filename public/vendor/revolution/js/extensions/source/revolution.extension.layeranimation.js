...
(function( $ ) {
    ...
    jQuery.extend( true, _R, {
                        ...
                        _nc.hover(
                            function( e ) {
                                ...
                                if ( intl && intl.progress() == 1 ) {
                                    ...
                                    if ( nc.data( 'newhoveranim' ) === undefined || nc.data( 'newhoveranim' ) === "none" ) {
                                        ...
                                        if ( $svg.svg ) {
                                            nc.data( 'newsvghoveranim' ).progress( 0 ).play();
                                        }
                                    }
                                }
                            },
                            function( e ) {
                                ...
                                if ( intl && intl.progress() == 1 && nc.data( 'newhoveranim' ) != undefined ) {
                                    ...
                                    if ( $svg.svg ) {
                                        nc.data( 'newsvghoveranim' ).reverse();
                                    }
                                }
                            }
                        );
        ...
        endMoveCaption: function( _nc, _mw, _pw, opt ) {
            ...
            } else if ( _nc.data( '_pw' ) === undefined ) {
                return;
            }
    ...
    var setSVGAnimObject = function( data, a ) {
        ...
        if ( customarray ) {
            jQuery.each( customarray, function( index, pa ) {
                ...
                if ( w == "sw" ) {
                    a.anim.strokeWidth = v;
                }
                if ( w == "sda" ) {
                    a.anim.strokeDasharray = v;
                }
                if ( w == "sdo" ) {
                    a.anim.strokeDashoffset = v;
                }
            } );
        }
        return a;
    ...
    var getcssParams = function( nc, level ) {
        ...
        // CHECK IF CURRENT ELEMENT SHOULD RESPECT REKURSICVE RESIZES, AND SHOULD OWN THE SAME ATTRIBUTES FROM PARRENT
        // ELEMENT
        if ( level == "rekursive" ) {
