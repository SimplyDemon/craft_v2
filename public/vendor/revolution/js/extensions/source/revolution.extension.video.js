    ...
    jQuery.extend( true, _R, {
        ...
        resetVideo: function( _nc, opt ) {
            switch ( _nc.data( 'videotype' ) ) {
                ...
                case "html5":
                    if ( _ISM && _nc.data( 'disablevideoonmobile' ) == 1 ) {
                        return false;
                    }
        ...
        manageVideoLayer: function( _nc, opt, recalled, internrecalled ) {
            ...
            switch ( newvideotype ) {
                case "html5":
                    ...
                    if ( videopreload == "auto" ) {
                        opt.mediapreload = true;
                    }
        ...
        if ( _nc.data( 'videolistenerexist' ) !== 1 ) {
            switch ( _nc.data( 'videotype' ) ) {
                ...
                case "vimeo":
                    ...
                    try { isrc = isrc.replace( 'api=0', 'api=1' ); }
                    catch ( e ) {}
                    isrc = isrc + "&api=1";
                    ifr.attr( 'src', isrc );
