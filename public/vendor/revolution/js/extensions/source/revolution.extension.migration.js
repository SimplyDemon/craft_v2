...
(function( $ ) {
    ...
    var prepLayerAnimations = function( container, opt ) {
        ...
        container.find( '.tp-caption' ).each( function() {
            ...
            } else if ( ncc.match( /\blfl\b/ ) ) {
                cp.data( 'transform_in', c.lfl )
            } else if ( ncc.match( /\blfr\b/ ) ) {
                cp.data( 'transform_in', c.lfr )
            } else if ( ncc.match( /\blft\b/ ) ) {
                cp.data( 'transform_in', c.lft )
            } else if ( ncc.match( /\blfb\b/ ) ) {
                cp.data( 'transform_in', c.lfb )
            } else if ( ncc.match( /\bsfl\b/ ) ) {
                cp.data( 'transform_in', c.sfl )
            } else if ( ncc.match( /\bsfr\b/ ) ) {
                cp.data( 'transform_in', c.sfr )
            } else if ( ncc.match( /\bsft\b/ ) ) {
                cp.data( 'transform_in', c.sft )
            } else if ( ncc.match( /\bsfb\b/ ) ) {
                cp.data( 'transform_in', c.sfb )
            ...
            } else if ( ncc.match( /\bfade\b/ ) ) {
                cp.data( 'transform_in', c.fade );
            }

            if ( ncc.match( /\brandomrotateout\b/ ) ) {
                cp.data( 'transform_out', c.randomrotate )
            } else if ( ncc.match( /\bltl\b/ ) ) {
                cp.data( 'transform_out', c.lfl )
            } else if ( ncc.match( /\bltr\b/ ) ) {
                cp.data( 'transform_out', c.lfr )
            } else if ( ncc.match( /\bltt\b/ ) ) {
                cp.data( 'transform_out', c.lft )
            } else if ( ncc.match( /\bltb\b/ ) ) {
                cp.data( 'transform_out', c.lfb )
            } else if ( ncc.match( /\bstl\b/ ) ) {
                cp.data( 'transform_out', c.sfl )
            } else if ( ncc.match( /\bstr\b/ ) ) {
                cp.data( 'transform_out', c.sfr )
            } else if ( ncc.match( /\bstt\b/ ) ) {
                cp.data( 'transform_out', c.sft )
            } else if ( ncc.match( /\bstb\b/ ) ) {
                cp.data( 'transform_out', c.sfb )
            ...
            } else if ( ncc.match( /\bfadeout\b/ ) ) {
                cp.data( 'transform_out', c.fade );
            }
