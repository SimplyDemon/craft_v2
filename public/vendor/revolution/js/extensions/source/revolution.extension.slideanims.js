...
(function( $ ) {
	...
	*/
    ...
    var gSlideTransA = function( a, i ) {
        if ( i == undefined || jQuery.isNumeric( a ) ) {
            return a;
        }
        if ( a == undefined ) {
            return a;
    ...
    var animateSlideIntern = function( nexttrans, comingtransition, container, opt, nextli, actli, nextsh, actsh, mtl ) {
        ...
        if ( opt.sc_indicator == "arrow" ) {
            slidedirection = opt.sc_indicator_dir;
        }
        ...
        if ( nexttrans == 26 ) {
            ...
            mtl.add( punchgs.TweenLite.to( actsh, masterspeed / 1000, {
                autoAlpha: 0,
                force3D: "auto",
                ease: ei
            } ), 0 );
        ...
        if ( nexttrans == 20 ) {								// FLYIN
            ...
            nextsh.find( '.slotslide' ).each( function( j ) {
                ...
                mtl.add( punchgs.TweenLite.fromTo( ss, masterspeed / 1000,
                    ...
                    { left: 0, rotationX: 0, opacity: 1, top: 0, z: 0, scale: 1, rotationY: 0, delay: d, ease: ei }
                ), 0 );
        ...
        if ( nexttrans == 23 || nexttrans == 24 ) {								// cube-horizontal - inboxhorizontal
            ...
            actsh.find( '.slotslide' ).each( function( j ) {
                ...
                if ( nexttrans == 23 ) {
                    mtl.add( punchgs.TweenLite.fromTo( ss, masterspeed / 2000, { autoAlpha: 1 }, {
                        autoAlpha: 0,
