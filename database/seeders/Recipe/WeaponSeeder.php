...
class WeaponSeeder extends Seeder {
    ...
    protected function addSwords() {
        ...
        seederAddRecipe( 'Flamberge', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, null, 4 );
        ...
        seederAddRecipe( 'Shamshir', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, null, 5 );
        seederAddRecipe( 'Katana', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, null, 5 );
        seederAddRecipe( 'Spirit Sword', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, null, 5 );
        seederAddRecipe( 'Raid Sword', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, null, 5 );
        seederAddRecipe( 'Caliburs', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, null, 5 );
        seederAddRecipe( 'Sword of Delusion', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, 'делюжен, делюшен, меч, sword', 5 );
        seederAddRecipe( 'Tsurugi', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, null, 5 );
        seederAddRecipe( 'Homunkulus\' Sword', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, 'хома, хомка, меч, sword', 5 );
        seederAddRecipe( 'Sword of Limit', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, null, 5 );
        seederAddRecipe( 'Sword of Nightmare', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, null, 5 );
        seederAddRecipe( 'Sword of Whispering Death', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, null, 5 );
        seederAddRecipe( 'Pa\'agrian Sword', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, null, 5 );
    ...
    protected function addBlunts() {
        ...
        seederAddRecipe( 'Big Hammer', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, null, 4 );
        seederAddRecipe( 'Battle Axe', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, null, 4 );
        seederAddRecipe( 'Silver Axe', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, null, 4 );
        seederAddRecipe( 'Skull Graver', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, null, 4 );
        seederAddRecipe( 'Heavy Doom Hammer', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, null, 4 );
        seederAddRecipe( 'Crystal Staff', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, null, 4 );
        seederAddRecipe( 'Stick of Faith', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, null, 4 );
        seederAddRecipe( 'Heavy Doom Axe', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, null, 4 );
        seederAddRecipe( 'Cursed Staff', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, null, 5 );
        seederAddRecipe( 'Dwarven War Hammer', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, null, 5 );
        seederAddRecipe( 'War Axe', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, 'вар акс', 5 );
        seederAddRecipe( 'Nirvana Axe', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, null, 5 );
        seederAddRecipe( 'Stick of Eternity', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, null, 5 );
        seederAddRecipe( 'Paradia Staff', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, null, 5 );
        seederAddRecipe( 'Inferno Staff', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, 'инферно', 5 );
        seederAddRecipe( 'Pa\'agrio Hammer', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, null, 5 );
        seederAddRecipe( 'Sage\'s Staff', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, '', 5 );
        seederAddRecipe( 'Club of Nature', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, null, 5 );
        seederAddRecipe( 'Mace of Underworld', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, null, 5 );
        seederAddRecipe( 'Karik Horn', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, null, 5 );
        seederAddRecipe( 'Pa\'agrio Axe', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, null, 5 );
        seederAddRecipe( 'Deadman\'s Staff', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, null, 6 );
        seederAddRecipe( 'Ghoul\'s Staff', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, null, 6 );
    ...
    protected function addBows() {
        ...
        seederAddRecipe( 'Elemental Bow', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, null, 5 );
        seederAddRecipe( 'Noble Elven Bow', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, null, 5 );
    ...
    protected function addDaggers() {
        ...
        seederAddRecipe( 'Cursed Dagger', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, null, 4 );
        seederAddRecipe( 'Dark Elven Dagger', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, 'дагер, даггер, dagger, dager', 4 );
        seederAddRecipe( 'Stiletto', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, null, 5 );
        seederAddRecipe( 'Soulfire Dirk', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, null, 5 );
    ...
    protected function addPolearms() {
        ...
        seederAddRecipe( 'Scythe', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, null, 4 );
        seederAddRecipe( 'Orcish Glaive', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, null, 4 );
        seederAddRecipe( 'Body Slasher', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, null, 4 );
        seederAddRecipe( 'Bec de Corbin', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, null, 5 );
        seederAddRecipe( 'Poleaxe', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, null, 5 );
        seederAddRecipe( 'Scorpion', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, null, 5 );
        seederAddRecipe( 'Widow Maker', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, null, 5 );
    ...
    protected function addFists() {
        ...
        seederAddRecipe( 'Chakram', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, null, 4 );
        seederAddRecipe( 'Knuckle Duster', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, null, 5 );
        seederAddRecipe( 'Fisted Blade', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, null, 5 );
