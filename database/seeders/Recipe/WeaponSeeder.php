...
class WeaponSeeder extends Seeder {
    ...
    protected function addSwords() {
        ...
        seederAddRecipe(
            ...
            0,
            '60',
            'Увеличивает количество получаемого Хила на 37',
            'Holy Spirit',
            1,
            false,
            'Легендарный Меч, сом, som, миракл, меч, sword',
            null,
            1659,
            12,
            140,
            ...
            'Magic Silence',
            'Acumen',
            'При использовании магических умений увеличивает потребление МП на 15% и Увеличивает Маг. Атк. на 167',
            'Даёт 10% шанс наложить Безмолвие при использовании вредоносного умения на цель',
            'Увеличивает Скорость Каста на 15%'
        );
    ...
    protected function addBlunts() {
        ...
        seederAddRecipe(
            ...
            0,
            '60',
            'Увеличивает количество получаемого Хила на 33',
            'Holy Spirit',
            1,
            false,
            'Посох Злых Духов, спирит',
            null,
            1346,
            10,
            339,
            ...
            'Blessed Body',
            'Poison',
            'Даёт 20% шанс наложения Focus (lvl 3) при использовании благотворного умения на цель',
            'Даёт 20% шанс наложить Blessed Body (lvl 5) при использовании благотворного умения на цель',
            'Даёт 6% шанс наложить Poison при использовании вредоносного умения на цель'
        );
        seederAddRecipe(
            'Staff of Evil Spirits 100%',
            $imagePath,
            0,
            'B',
            $categoryId,
        ...
        seederAddRecipe(
            ...
            0,
            '60',
            'Увеличивает количество получаемого Хила на 43',
            'Holy Spirit',
            1,
            false,
            'Посох Династии, стафф, дино',
            null,
            3597,
            14,
            285,
            ...
            'Conversion',
            'Acumen',
            'Увеличивает MP на 30%',
            'Увеличивает MP на 60% и уменьшает HP на 40%',
            'Увеличивает Скорость Каста на 15%'
        );
    ...
    protected function addPolearms() {
        ...
        seederAddRecipe( 'Halberd', $imagePath, 0, 'A', $categoryId, 0, '60', 'Увеличивает Физ. Крит. Атк. на 54.4', 'Lightning', 1, false, 'Алебарда, халберд, пика, алебарда, древковое', 7, 1128,
            11, 147, 'Haste', 'Critical Stun', 'Wide Blow', 'Увеличивает Скорость атаки на 6%', 'Даёт 25% шанс застанить При критической атаке', 'Увеличивает Угол Атаки' );
