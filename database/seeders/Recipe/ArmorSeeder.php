...
class ArmorSeeder extends Seeder {
    ...
    protected function addShield() {
        ...
        seederAddRecipe( 'Zubei\'s Shield', $imagePath, 1300000, 'B', $categoryId, 0, '60', 'Multiplies M.Def by 1.02', null, 1, false, 'Щит Зубея, зубей' );
        seederAddRecipe( 'Zubei\'s Shield 100%', $imagePath, 1300000, 'B', $categoryId, 0, '100', 'Multiplies M.Def by 1.02', null, 1, false, 'Щит Зубея, зубей' );
        seederAddRecipe( 'Avadon Shield', $imagePath, 0, 'B', $categoryId, 0, '60', 'Multiplies M.Def by 1.01', null, 1, false, 'Щит Авадона' );
        seederAddRecipe( 'Avadon Shield 100%', $imagePath, 0, 'B', $categoryId, 0, '100', 'Multiplies M.Def by 1.01', null, 1, false, 'Щит Авадона' );
        ...
        seederAddRecipe( 'Dark Crystal Shield', $imagePath, 3000000, 'A', $categoryId, 0, '60', 'Multiplies M.Def by 1.02', null, 1, false, 'Щит Кристалла Тьмы, дк, dc' );
    ...
    protected function addArmorLightFullBody() {
        ...
        seederAddRecipe( 'Avadon Leather Armor', $imagePath, 0, 'B', $categoryId, 0, '60', 'Adds Max Load by 11038<br>Multiplies M.Def by 1.1708', null, 1, false, 'Кожаный Доспех Авадона, тело, лайт, light' );
        seederAddRecipe( 'Avadon Leather Armor 100%', $imagePath, 0, 'B', $categoryId, 0, '100', 'Adds Max Load by 11038<br>Multiplies M.Def by 1.1708', null, 1, false, 'Кожаный Доспех Авадона, тело, лайт, light' );
        ...
        seederAddRecipe( 'Tallum Leather Armor', $imagePath, 27000000, 'A', $categoryId, 0, '60', 'Adds Bleed Vulnerability by 52<br>Adds Max MP by 315<br>Adds Poison Vulnerability by 52<br>Multiplies Regen MP by 1.0932', null, 1, false, 'Кожаный Доспех Таллума, тело, лайт, light' );
    ...
    protected function addArmorLightUpper() {
        ...
        seederAddRecipe( 'Zubei\'s Leather Shirt', $imagePath, 1500000, 'B', $categoryId, 0, '60', 'Adds Rate Evasion by 9.55', null, 1, false, 'Кожаная Рубаха Зубея, зубей, верх, тело, лайт, light' );
        seederAddRecipe( 'Zubei\'s Leather Shirt 100%', $imagePath, 1500000, 'B', $categoryId, 0, '100', 'Adds Rate Evasion by 9.55', null, 1, false, 'Кожаная Рубаха Зубея, зубей, верх, тело, лайт, light' );
        seederAddRecipe( 'Dark Crystal Leather Armor', $imagePath, 4500000, 'A', $categoryId, 0, '60', 'Decreases Paralyze Vulnerability by 20<br>Multiplies P.Atk Speed by 1.0724<br>Multiplies P.Atk by 1.0724', null, 1, false, 'Кожаный Доспех Кристалла Тьмы, дк, dc, верх, тело, лайт, light' );
    ...
    protected function addArmorLightLower() {
        ...
        seederAddRecipe( 'Zubei\'s Leather Gaiters', $imagePath, 2500000, 'B', $categoryId, 0, '60', 'Adds Rate Evasion by 1.47', null, 1, false, 'Кожаные Набедренники Зубея, зубей, низ, лайт, light' );
        seederAddRecipe( 'Zubei\'s Leather Gaiters 100%', $imagePath, 2500000, 'B', $categoryId, 0, '100', 'Adds Rate Evasion by 1.47', null, 1, false, 'Кожаные Набедренники Зубея, зубей, низ, лайт, light' );
        seederAddRecipe( 'Dark Crystal Leggings', $imagePath, 4400000, 'A', $categoryId, 0, '60', 'Multiplies P.Atk Speed by 1.0103<br>Multiplies P.Atk by 1.0103<br>Decreases Paralyze Vulnerability by 12.5', null, 1, false, 'Поножи Кристалла Тьмы, дк, dc, низ, лайт, light' );
    ...
    protected function addArmorHeavyFullBody() {
        ...
        seederAddRecipe( 'Tallum Plate Armor', $imagePath, 42000000, 'A', $categoryId, 0, '60', 'Adds Bleed Vulnerability by 52<br>Adds Max Load by 8159<br>Adds Poison Vulnerability by 52<br>Multiplies P.Atk Speed by 1.0932', null, 1, false, 'Латный Доспех Таллума, тело, light, лайт' );
    ...
    protected function addArmorHeavyUpper() {
        ...
        seederAddRecipe( 'Zubei\'s Breastplate', $imagePath, 0, 'B', $categoryId, 0, '60', 'Adds Max HP by 294<br>Multiplies P.Def by 1.0724', null, 1, false, 'Кираса Зубея, зубей, верх, хеви, heavy' );
        seederAddRecipe( 'Zubei\'s Breastplate 100%', $imagePath, 0, 'B', $categoryId, 0, '100', 'Adds Max HP by 294<br>Multiplies P.Def by 1.0724', null, 1, false, 'Кираса Зубея, зубей, верх, хеви, heavy' );
        seederAddRecipe( 'Avadon Breastplate', $imagePath, 3000000, 'B', $categoryId, 0, '60', 'Adds Max HP by 833', null, 1, false, 'Кираса Авадона, верх, хеви, heavy' );
        seederAddRecipe( 'Avadon Breastplate 100%', $imagePath, 3000000, 'B', $categoryId, 0, '100', 'Adds Max HP by 833', null, 1, false, 'Кираса Авадона, верх, хеви, heavy' );
        ...
        seederAddRecipe( 'Dark Crystal Breastplate', $imagePath, 4500000, 'A', $categoryId, 0, '60', 'Multiplies Gain Hp by 1.12<br>Adds Paralyze Vulnerability by 20', null, 1, false, 'Кираса Кристалла Тьмы, дк, dc, верх, хеви, heavy' );
    ...
    protected function addArmorHeavyLower() {
        ...
        seederAddRecipe( 'Zubei\'s Gaiters', $imagePath, 0, 'B', $categoryId, 0, '60', 'Multiplies P.Def by 1.0208<br>Adds Max HP by 123', null, 1, false, 'Набедренники Зубея, зубей, низ, ноги, хеви, heavy' );
        seederAddRecipe( 'Zubei\'s Gaiters 100%', $imagePath, 0, 'B', $categoryId, 0, '100', 'Multiplies P.Def by 1.0208<br>Adds Max HP by 123', null, 1, false, 'Набедренники Зубея, зубей, низ, ноги, хеви, heavy' );
        seederAddRecipe( 'Avadon Gaiters', $imagePath, 2000000, 'B', $categoryId, 0, '60', 'Adds Max HP by 122', null, 1, false, 'Набедренники Авадона, низ, ноги, хеви, heavy' );
        seederAddRecipe( 'Avadon Gaiters 100%', $imagePath, 2000000, 'B', $categoryId, 0, '100', 'Adds Max HP by 122', null, 1, false, 'Набедренники Авадона, низ, ноги, хеви, heavy' );
        ...
        seederAddRecipe( 'Dark Crystal Gaiters', $imagePath, 6000000, 'A', $categoryId, 0, '60', 'Multiplies Gain Hp by 1.02<br>Decreases Paralyze Vulnerability by 12.5', null, 1, false, 'Набедренники Кристалла Тьмы, дк, dc, низ, ноги, хеви, heavy' );
    ...
    protected function addArmorRobeFullBody() {
        ...
        seederAddRecipe( 'Avadon Robe', $imagePath, 3700000, 'B', $categoryId, 0, '60', 'Multiplies M.Atk Spd by 1.15<br>Multiplies M.Def by 1.1708', null, 1, false, 'Мантия Авадона, тело, роба, robe, маг' );
        seederAddRecipe( 'Avadon Robe 100%', $imagePath, 3700000, 'B', $categoryId, 0, '100', 'Multiplies M.Atk Spd by 1.15<br>Multiplies M.Def by 1.1708', null, 1, false, 'Мантия Авадона, тело, роба, robe, маг' );
        seederAddRecipe( 'Dark Crystal Robe', $imagePath, 1250000, 'A', $categoryId, 0, '60', 'Adds Cancel Vulnerability by 8.33<br>Multiplies M.Atk Spd by 1.15<br>Adds Paralyze Vulnerability by 20<br>Multiplies P.Def by 1.0333<br>Adds Run Speed by 2.91', null, 1, false, 'Мантия Кристалла Тьмы, dc, дк, тело, роба, robe, маг' );
    ...
    protected function addArmorRobeUpper() {
        ...
        seederAddRecipe( 'Tunic of Zubei', $imagePath, 2000000, 'B', $categoryId, 0, '60', 'Multiplies M.Atk by 1.15', null, 1, false, 'Туника Зубея, зубей, верх, роба, маг, robe' );
        seederAddRecipe( 'Tunic of Zubei 100%', $imagePath, 2000000, 'B', $categoryId, 0, '100', 'Multiplies M.Atk by 1.15', null, 1, false, 'Туника Зубея, зубей, верх, роба, маг, robe' );
        ...
        seederAddRecipe( 'Tallum Tunic', $imagePath, 4000000, 'A', $categoryId, 0, '60', 'Multiplies M.Atk Spd by 1.15', null, 1, false, 'Туника Таллума, верх, роба, маг, robe' );
    ...
    protected function addArmorRobeLower() {
        ...
        seederAddRecipe( 'Stockings of Zubei', $imagePath, 0, 'B', $categoryId, 0, '60', 'Multiplies M.Atk by 1.0208', null, 1, false, 'Штаны Зубея, зубей, низ, маг, роба' );
        seederAddRecipe( 'Stockings of Zubei 100%', $imagePath, 0, 'B', $categoryId, 0, '100', 'Multiplies M.Atk by 1.0208', null, 1, false, 'Штаны Зубея, зубей, низ, маг, роба' );
        seederAddRecipe( 'Tallum Stockings', $imagePath, 2800000, 'A', $categoryId, 0, '60', 'Multiplies M.Def by 1.0333<br>Decreases Poison Vulnerability by 33.33<br>Decreases Bleed Vulnerability by 33.33', null, 1, false, 'Штаны Таллума, низ, маг, роба' );
    ...
    protected function addArmorUniversalHelmet() {
        ...
        seederAddRecipe( 'Avadon Circlet', $imagePath, 7500000, 'B', $categoryId, 0, '60', 'Heavy:<br>Adds Max HP by 73<br>Light:<br>Multiplies M.Def by 1.0125<br>Adds Max Load by 1440<br>Robe:<br>Multiplies P.Def by 1.0125', null, 1, false, 'Диадема Авадона, шлем, каска, голова' );
        seederAddRecipe( 'Avadon Circlet 100%', $imagePath, 7500000, 'B', $categoryId, 0, '100', 'Heavy:<br>Adds Max HP by 73<br>Light:<br>Multiplies M.Def by 1.0125<br>Adds Max Load by 1440<br>Robe:<br>Multiplies P.Def by 1.0125', null, 1, false, 'Диадема Авадона, шлем, каска, голова' );
        seederAddRecipe( 'Zubei\'s Helmet', $imagePath, 1600000, 'B', $categoryId, 0, '60', 'Heavy:<br>Multiplies P.Def by 1.0125<br>Adds Max HP by 74<br>Light:<br>Adds Rate Evasion by 0.88<br>Robe:<br>Multiplies M.Atk by 1.0125', null, 1, false, 'Шлем Зубея, зубей, шлем, каска, голова' );
        seederAddRecipe( 'Zubei\'s Helmet 100%', $imagePath, 1600000, 'B', $categoryId, 0, '100', 'Heavy:<br>Multiplies P.Def by 1.0125<br>Adds Max HP by 74<br>Light:<br>Adds Rate Evasion by 0.88<br>Robe:<br>Multiplies M.Atk by 1.0125', null, 1, false, 'Шлем Зубея, зубей, шлем, каска, голова' );
    ...
    protected function addArmorUniversalBoot() {
        ...
        seederAddRecipe( 'Avadon Boots', $imagePath, 0, 'B', $categoryId, 0, '60', 'Heavy:<br>Adds Max HP by 49<br>Light:<br>Multiplies M.Def by 1.0083<br>Adds Max Load by 960<br>Robe:<br>Multiplies P.Def by 1.0083', null, 1, false, 'Сапоги Авадона, боты, сапоги, ботинки' );
        seederAddRecipe( 'Avadon Boots 100%', $imagePath, 0, 'B', $categoryId, 0, '100', 'Heavy:<br>Adds Max HP by 49<br>Light:<br>Multiplies M.Def by 1.0083<br>Adds Max Load by 960<br>Robe:<br>Multiplies P.Def by 1.0083', null, 1, false, 'Сапоги Авадона, боты, сапоги, ботинки' );
        seederAddRecipe( 'Zubei\'s Boots', $imagePath, 4000000, 'B', $categoryId, 0, '60', 'Heavy:<br>Multiplies P.Def by 1.0083<br>Adds Max HP by 49<br>Light:<br>Adds Rate Evasion by 0.59<br>Robe:<br>Multiplies M.Atk by 1.0083', null, 1, false, 'Сапоги Зубея, зубей, боты, сапоги, ботинки' );
        seederAddRecipe( 'Zubei\'s Boots 100%', $imagePath, 4000000, 'B', $categoryId, 0, '100', 'Heavy:<br>Multiplies P.Def by 1.0083<br>Adds Max HP by 49<br>Light:<br>Adds Rate Evasion by 0.59<br>Robe:<br>Multiplies M.Atk by 1.0083', null, 1, false, 'Сапоги Зубея, зубей, боты, сапоги, ботинки' );
    ...
    protected function addArmorUniversalGloves() {
        ...
        seederAddRecipe( 'Avadon Gloves', $imagePath, 2300000, 'B', $categoryId, 0, '60', 'Heavy:<br>Adds Max HP by 49<br>Light:<br>Multiplies M.Def by 1.0083<br>Adds Max Load by 960<br>Robe:<br>Multiplies P.Def by 1.0083', null, 1, false, 'Перчатки Авадона, перчатки, перчи, рукавицы' );
        seederAddRecipe( 'Avadon Gloves 100%', $imagePath, 2300000, 'B', $categoryId, 0, '100', 'Heavy:<br>Adds Max HP by 49<br>Light:<br>Multiplies M.Def by 1.0083<br>Adds Max Load by 960<br>Robe:<br>Multiplies P.Def by 1.0083', null, 1, false, 'Перчатки Авадона, перчатки, перчи, рукавицы' );
