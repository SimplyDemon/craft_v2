...
class ArmorSeeder extends Seeder {
    ...
    protected function addShield() {
        ...
        seederAddRecipe( 'Zubei\'s Shield', $imagePath, 1300000, 'B', $categoryId, 0, '60', 'Увеличивает Маг. Защ. на 2%', null, 1, false, 'Щит Зубея, зубей', 6, 56, );
        seederAddRecipe( 'Zubei\'s Shield 100%', $imagePath, 1300000, 'B', $categoryId, 0, '100', 'Увеличивает Маг. Защ. на 2%', null, 1, false, 'Щит Зубея, зубей', 6, 56, );
        ...
        seederAddRecipe( 'Doom Shield', $imagePath, 350000, 'B', $categoryId, 0, '60', 'Увеличивает Маг. Защ. на 2%', null, 1, false, 'Щит Рока, дум', null, 87 );
        seederAddRecipe( 'Doom Shield 100%', $imagePath, 350000, 'B', $categoryId, 0, '100', 'Увеличивает Маг. Защ. на 2%', null, 1, false, 'Щит Рока, дум', null, 87 );
        seederAddRecipe( 'Dark Crystal Shield', $imagePath, 3000000, 'A', $categoryId, 0, '60', 'Увеличивает Маг. Защ. на 2%', null, 1, false, 'Щит Кристалла Тьмы, дк, dc', 7, 75, );
        seederAddRecipe( 'Shield of Nightmare', $imagePath, 5000000, 'A', $categoryId, 0, '60', 'Увеличивает Маг. Защ. на 2%', null, 1, false, 'Щит Кошмаров, нм, nm', null, 114 );
        seederAddRecipe( 'Imperial Crusader Shield', $imagePath, 13000000, 'S', $categoryId, 0, '60', 'Увеличивает Маг. Защ. на 2%', null, 1, false, 'Щит Имперского Крестоносца, ик, ic', null, 161 );
        seederAddRecipe( 'Dynasty Shield', $imagePath, 7000000, 'S', $categoryId, 0, '60', 'Увеличивает Маг. Защ. на 2%', null, 1, false, 'Щит Династии, дино', null, 307 );
        seederAddRecipe( 'Moirai Shield', $imagePath, 25000000, 'S-80', $categoryId, 0, '60', 'Увеличивает Защиту от Магии на 2%', null, 1, false, 'Щит Дестино, морай', null, 424 );
        seederAddRecipe( 'Vesper Shield', $imagePath, 19000000, 'S-84', $categoryId, 0, '60', 'Увеличивает Защиту от Магии на 2%', null, 1, false, 'Щит Венеры, веспер', null, 588 );
    }
    ...
    protected function addSigil() {
        ...
        seederAddRecipe( 'Dynasty Sigil', $imagePath, 24000000, 'S', $categoryId, 0, '60', 'Увеличивает Маг. Защ. на 2% и Защиту от Тьмы на 2.', null, 1, false, 'Символ Династии, дино, сигиль, sigil', null, 307 );
        seederAddRecipe( 'Moirai Sigil', $imagePath, 25000000, 'S-80', $categoryId, 0, '60', 'Увеличивает Защиту от Магии на 2%', null, 1, false, 'Символ Дестино, морай,  сигиль, sigil', null, 424 );
    ...
    protected function addArmorLightFullBody() {
        ...
        seederAddRecipe( 'Blue Wolf Leather Armor', $imagePath, 5000000, 'B', $categoryId, 0, '60', 'Увеличивает Скорость Каста  на 15%<br>Увеличивает Физ. Защ.  на 2.19%', null, 1, false, 'Кожаный Доспех Синего Волка, бв, bw, тело, лайт, light', null, 402 );
        seederAddRecipe( 'Blue Wolf Leather Armor 100%', $imagePath, 5000000, 'B', $categoryId, 0, '100', 'Увеличивает Скорость Каста  на 15%<br>Увеличивает Физ. Защ.  на 2.19%', null, 1, false, 'Кожаный Доспех Синего Волка, бв, bw, тело, лайт, light', null, 402 );
        seederAddRecipe( 'Leather Armor of Doom', $imagePath, 6500000, 'B', $categoryId, 0, '60', 'Увеличивает Объём Лёгких на 383<br>Увеличивает Физ. Атк. на 8.27%<br>Увеличивает Защиту от Отправления на 13<br>Увеличивает Реген MP  на 8.27%', null, 1, false, 'Кожаный Доспех Рока, дум, тело, лайт, light', null, 402 );
        seederAddRecipe( 'Leather Armor of Doom 100%', $imagePath, 6500000, 'B', $categoryId, 0, '100', 'Увеличивает Объём Лёгких на 383<br>Увеличивает Физ. Атк. на 8.27%<br>Увеличивает Защиту от Отправления на 13<br>Увеличивает Реген MP  на 8.27%', null, 1, false, 'Кожаный Доспех Рока, дум, тело, лайт, light', null, 402 );
        seederAddRecipe( 'Tallum Leather Armor', $imagePath, 27000000, 'A', $categoryId, 0, '60', 'Увеличивает Защиту от Кровотечений на 52<br>Увеличивает MP на 315<br>Увеличивает Защиту от Яда на 52<br>Увеличивает Реген MP на 9.32%', null, 1, false, 'Кожаный Доспех Таллума, тело, лайт, light', 7, 347, );
        seederAddRecipe( 'Leather Armor of Nightmare', $imagePath, 14000000, 'A', $categoryId, 0, '60', 'Увеличивает Вампиризм на 3<br>Увеличивает Маг. Защ. на 8.27%<br>Увеличивает Защиту от Рута на 29.16<br>Увеличивает Защиту от Сна на 29.16', null, 1, false, 'Кожаный Доспех Кошмаров, тело, лайт, light', null, 528 );
        seederAddRecipe( 'Majestic Leather Armor', $imagePath, 17500000, 'A', $categoryId, 0, '60', 'Увеличивает Грузоподъёмность на 8159<br>Увеличивает MP на 340<br>Увеличивает Физ. Атк. на 9.32%<br>Увеличивает Защиту от Стана на 20.83', null, 1, false, 'Кожаный Доспех Величия, мж, mj, тело, лайт, light', null, 528 );
    ...
    protected function addArmorLightUpper() {
        ...
        seederAddRecipe( 'Zubei\'s Leather Shirt', $imagePath, 1500000, 'B', $categoryId, 0, '60', 'Увеличивает Уклонение на 9.55', null, 1, false, 'Кожаная Рубаха Зубея, зубей, верх, тело, лайт, light', 6, 160, );
        seederAddRecipe( 'Zubei\'s Leather Shirt 100%', $imagePath, 1500000, 'B', $categoryId, 0, '100', 'Увеличивает Уклонение на 9.55', null, 1, false, 'Кожаная Рубаха Зубея, зубей, верх, тело, лайт, light', 6, 160, );
        seederAddRecipe( 'Dark Crystal Leather Armor', $imagePath, 4500000, 'A', $categoryId, 0, '60', 'Увеличивает Защиту от Паралича на 20<br>Увеличивает Скорость Атаки на 7.24%<br>Увеличивает Физ. Атк. на 7.24%', null, 1, false, 'Кожаный Доспех Кристалла Тьмы, дк, dc, верх, тело, лайт, light', 7, 214, );
        seederAddRecipe( 'Dynasty Leather Armor', $imagePath, 62000000, 'S', $categoryId, 0, '60', 'Увеличивает Точность на 3.4<br>Увеличивает Защиту от Тьмы на 3.2<br>Увеличивает MP на 492<br>Увеличивает Скорость Атаки на 4.77%<br>Увеличивает Уклонение на 3.4', null, 1, false, 'Кожаный Доспех Династии, дино, верх, тело, лайт, light', null, 878 );
        seederAddRecipe( 'Moirai Leather Breastplate', $imagePath, 117000000, 'S-80', $categoryId, 0, '60', 'Увеличивает Физ. Атк. на 4.26%<br>Увеличивает Защиту от Рута на 5<br>Увеличивает Реген MP на 4%<br>Увеличивает Защиту от Воды на 3', null, 1, false, 'Кожаная Кираса Дестино, морай, верх, тело, лайт, light', null, 1212 );
        seederAddRecipe( 'Vesper Leather Breastplate', $imagePath, 35000000, 'S-84', $categoryId, 0, '60', 'Увеличивает Физ. Атк. на 5.57%<br>Увеличивает Скорость Атаки на 5%<br>Увеличивает Реген MP на 5%<br>Увеличивает MP на 347', null, 1, false, 'Кожаная Кираса Венеры, веспер, верх, тело, лайт, light', null, 1680 );
    }
    ...
    protected function addArmorLightLower() {
        ...
        seederAddRecipe( 'Zubei\'s Leather Gaiters', $imagePath, 2500000, 'B', $categoryId, 0, '60', 'Увеличивает Уклонение на 1.47', null, 1, false, 'Кожаные Набедренники Зубея, зубей, низ, лайт, light', 6, 100, );
        seederAddRecipe( 'Zubei\'s Leather Gaiters 100%', $imagePath, 2500000, 'B', $categoryId, 0, '100', 'Увеличивает Уклонение на 1.47', null, 1, false, 'Кожаные Набедренники Зубея, зубей, низ, лайт, light', 6, 100, );
        seederAddRecipe( 'Dark Crystal Leggings', $imagePath, 4400000, 'A', $categoryId, 0, '60', 'Увеличивает Скорость Атаки на 1.03%<br>Увеличивает Физ. Атк. на 1.03%<br>Увеличивает Защиту от Паралича на 12.5', null, 1, false, 'Поножи Кристалла Тьмы, дк, dc, низ, лайт, light', 7, 134, );
        ...
        seederAddRecipe( 'Moirai Leather Leggings', $imagePath, 69000000, 'S-80', $categoryId, 0, '60', 'Увеличивает Физ. Атк. на 2.08%<br>Увеличивает Защиту от Рута на 5<br>Увеличивает Реген MP на 1%67<br>Увеличивает Защиту от Воды на 3', null, 1, false, 'Кожаные Брюки Дестино, морай, низ, лайт, light', null, 758 );
        seederAddRecipe( 'Vesper Leather Leggings', $imagePath, 40000000, 'S-84', $categoryId, 0, '60', 'Увеличивает Физ. Атк. на 0.68%<br>Увеличивает Скорость Атаки на 0.68%<br>Увеличивает Реген MP на 0.68%<br>Увеличивает MP на 145', null, 1, false, 'Кожаные Брюки Венеры, веспер, низ, лайт, light', null, 1050 );
    }
    ...
    protected function addArmorLightHelmet() {
        ...
        seederAddRecipe( 'Draconic Leather Helmet', $imagePath, 20000000, 'S', $categoryId, 0, '60', 'Увеличивает Скорость Атаки на 0.62%<br>Увеличивает Физ. Атк. на 0.62%<br>Увеличивает MP на 111<br>Увеличивает Грузоподъёмность на 1440', null, 1, false, 'Шлем из Драконьей Кожи, драконик, шлем, голова, каска, лайт, light', null, 230 );
        seederAddRecipe( 'Dynasty Leather Helmet', $imagePath, 11000000, 'S', $categoryId, 0, '60', 'Увеличивает Точность на 0.47<br>Увеличивает Уклонение на 0.47<br>Увеличивает HP на 123<br>Увеличивает Скорость Атаки на 0.41%<br>Увеличивает Защиту от Тьмы на 1.2', null, 1, false, 'Шлем Династии, дино, шлем, голова, каска, лайт, light', null, 439 );
        ...
        seederAddRecipe( 'Vesper Leather Helmet', $imagePath, 22000000, 'S-84', $categoryId, 0, '60', 'Увеличивает Физ. Атк. на 0.41%<br>Увеличивает Скорость Атаки на 0.41%<br>Увеличивает Реген MP на 0.41%<br>Увеличивает MP на 87', null, 1, false, 'Шлем Венеры, веспер, шлем, голова, каска, лайт, light', null, 840 );
    }
    ...
    protected function addArmorLightBoot() {
        ...
        seederAddRecipe( 'Dynasty Leather Boots', $imagePath, 21000000, 'S', $categoryId, 0, '60', 'Увеличивает Точность на 0.31<br>Увеличивает Уклонение на 0.31<br>Увеличивает HP на 82<br>Увеличивает Скорость Атаки на 0.27%<br>Увеличивает Защиту от Тьмы на 0.8', null, 1, false, 'Кожаные Сапоги Династии, дино, боты, ботинки, сапоги, лайт, light', null, 293 );
        seederAddRecipe( 'Moirai Leather Boots', $imagePath, 20000000, 'S-80', $categoryId, 0, '60', 'Увеличивает Физ. Атк. на 0.83%<br>Увеличивает Защиту от Рута на 5<br>Увеличивает Реген MP на 0.67%<br>Увеличивает Защиту от Земли на 3', null, 1, false, 'Кожаные Сапоги Дестино, морай, боты, ботинки, сапоги, лайт, light', null, 404 );
        seederAddRecipe( 'Vesper Leather Boots', $imagePath, 30000000, 'S-84', $categoryId, 0, '60', 'Увеличивает Физ. Атк. на 0.27%<br>Увеличивает Скорость Атаки на 0.27%<br>Увеличивает Реген MP на 0.27%<br>Увеличивает MP на 58', null, 1, false, 'Кожаные Сапоги Венеры, веспер, боты, ботинки, сапоги, лайт, light', null, 560 );
    }
    ...
    protected function addArmorLightGloves() {
        ...
        seederAddRecipe( 'Draconic Leather Gloves', $imagePath, 3000000, 'S', $categoryId, 0, '60', 'Увеличивает Скорость Атаки на 0.41%<br>Увеличивает Физ. Атк. на 0.41%<br>Увеличивает MP на 74<br>Увеличивает Грузоподъёмность на 960', null, 1, false, 'Перчатки из Драконьей Кожи, драконик, перчи, перчатки, рукавицы, лайт, light', null, 153 );
        ...
        seederAddRecipe( 'Moirai Leather Gloves', $imagePath, 15000000, 'S-80', $categoryId, 0, '60', 'Увеличивает Физ. Атк. на 0.83%<br>Увеличивает Защиту от Рута на 5<br>Увеличивает Реген MP на 0.67%<br>Увеличивает Защиту от Воздуха на 3', null, 1, false, 'Кожаные Перчатки Дестино, морай, перчи, перчатки, рукавицы, лайт, light', null, 404 );
        seederAddRecipe( 'Vesper Leather Gloves', $imagePath, 43000000, 'S-84', $categoryId, 0, '60', 'Увеличивает Физ. Атк. на 0.27%<br>Увеличивает Скорость Атаки на 0.27%<br>Увеличивает Реген MP на 0.27%<br>Увеличивает MP на 58', null, 1, false, 'Кожаные Перчатки Венеры, веспер, перчи, перчатки, рукавицы, лайт, light', null, 560 );
    }
    ...
    protected function addArmorHeavyFullBody() {
        ...
        seederAddRecipe( 'Doom Plate Armor', $imagePath, 11000000, 'B', $categoryId, 0, '60', 'Увеличивает Объём Лёгких на 383<br>Увеличивает HP на 1093', null, 1, false, 'Латный Доспех Рока, дум, тело, heavy, хеви', null, 536 );
        seederAddRecipe( 'Doom Plate Armor 100%', $imagePath, 11000000, 'B', $categoryId, 0, '100', 'Увеличивает Объём Лёгких на 383<br>Увеличивает HP на 1093', null, 1, false, 'Латный Доспех Рока, дум, тело, heavy, хеви', null, 536 );
        seederAddRecipe( 'Tallum Plate Armor', $imagePath, 42000000, 'A', $categoryId, 0, '60', 'Увеличивает Защиту от Кровотечений на 52<br>Увеличивает Грузоподъёмность на 8159<br>Увеличивает Защиту от Яда на 52<br>Увеличивает Скорость Атаки на 9.32%', null, 1, false, 'Латный Доспех Таллума, тело, heavy, хеви', 7, 463, );
        ...
        seederAddRecipe( 'Majestic Plate Armor', $imagePath, 25000000, 'A', $categoryId, 0, '60', 'Увеличивает Точность на 0.579<br>Увеличивает Физ. Атк. на 8.27%<br>Увеличивает Защиту от Стана на 20.83', null, 1, false, 'Латный Доспех Величия, мж, mj, тело, heavy, хеви', null, 704 );
    ...
    protected function addArmorHeavyUpper() {
        ...
        seederAddRecipe( 'Avadon Breastplate', $imagePath, 3000000, 'B', $categoryId, 0, '60', 'Увеличивает HP на 833', null, 1, false, 'Кираса Авадона, верх, хеви, heavy', 6, 213, );
        seederAddRecipe( 'Avadon Breastplate 100%', $imagePath, 3000000, 'B', $categoryId, 0, '100', 'Увеличивает HP на 833', null, 1, false, 'Кираса Авадона, верх, хеви, heavy', 6, 213, );
        seederAddRecipe( 'Blue Wolf Breastplate', $imagePath, 5000000, 'B', $categoryId, 0, '60', 'Увеличивает Реген HP на 7.24%<br>Увеличивает Скорость Бега на 7', null, 1, false, 'Кираса Синего Волка, бв, bw, верх, хеви, heavy', null, 330 );
        seederAddRecipe( 'Blue Wolf Breastplate 100%', $imagePath, 5000000, 'B', $categoryId, 0, '100', 'Увеличивает Реген HP на 7.24%<br>Увеличивает Скорость Бега на 7', null, 1, false, 'Кираса Синего Волка, бв, bw, верх, хеви, heavy', null, 330 );
        seederAddRecipe( 'Dark Crystal Breastplate', $imagePath, 4500000, 'A', $categoryId, 0, '60', 'Увеличивает Эффективность магии, восстанавливающей HP самому себе на 12%<br>Увеличивает Защиту от Паралича на 20', null, 1, false, 'Кираса Кристалла Тьмы, дк, dc, верх, хеви, heavy', 7, 285, );
        seederAddRecipe( 'Imperial Crusader Breastplate', $imagePath, 5000000, 'S', $categoryId, 0, '60', 'Увеличивает HP на 889<br>Увеличивает Физ. Защ. на 7.24%<br>Увеличивает Защиту от Рута на 28<br>Увеличивает Защиту от Сна на 28', null, 1, false, 'Кираса Имперского Крестоносца, ик, ic, верх, хеви, heavy', null, 613 );
        seederAddRecipe( 'Dynasty Breastplate', $imagePath, 83000000, 'S', $categoryId, 0, '60', 'Увеличивает Защиту от Тьмы на 3.2<br>Увеличивает HP на 984<br>Увеличивает Физ. Защ. на 7.24%', null, 1, false, 'Кираса Династии, дино, верх, хеви, heavy', null, 1171 );
        ...
        seederAddRecipe( 'Vesper Breastplate', $imagePath, 80000000, 'S-84', $categoryId, 0, '60', 'Увеличивает Физ. Атк. на 5.57%<br>Увеличивает Физ. Защ. на 5.57%<br>Увеличивает HP на 531<br>Увеличивает Защиту от Сна на 28<br>Увеличивает Защиту от Рута на 28', null, 1, false, 'Кираса Венеры, весер, верх, хеви, heavy', null, 2240 );
    }
    ...
    protected function addArmorHeavyLower() {
        ...
        seederAddRecipe( 'Avadon Gaiters', $imagePath, 2000000, 'B', $categoryId, 0, '60', 'Увеличивает HP на 122', null, 1, false, 'Набедренники Авадона, низ, ноги, хеви, heavy', 6, 133, );
        seederAddRecipe( 'Avadon Gaiters 100%', $imagePath, 2000000, 'B', $categoryId, 0, '100', 'Увеличивает HP на 122', null, 1, false, 'Набедренники Авадона, низ, ноги, хеви, heavy', 6, 133, );
        ...
        seederAddRecipe( 'Dark Crystal Gaiters', $imagePath, 6000000, 'A', $categoryId, 0, '60', 'Увеличивает Эффективность магии, восстанавливающей HP самому себе на 2%<br>Увеличивает Защиту от Паралича на 12.5', null, 1, false, 'Набедренники Кристалла Тьмы, дк, dc, низ, ноги, хеви, heavy', 7, 178, );
        seederAddRecipe( 'Imperial Crusader Gaiters', $imagePath, 27000000, 'S', $categoryId, 0, '60', 'Увеличивает Физ. Защ. на 2.08%<br>Увеличивает HP на 185<br>Увеличивает Защиту от Сна на 17.5<br>Увеличивает Защиту от Рута на 17.5', null, 1, false, 'Набедренники Имперского Крестоносца, ик, ic, низ, ноги, хеви, heavy', null, 383 );
        seederAddRecipe( 'Dynasty Gaiters', $imagePath, 30000000, 'S', $categoryId, 0, '60', 'Увеличивает Физ. Защ. на 2.08%<br>Увеличивает HP на 205<br>Увеличивает Защиту от Тьмы на 2', null, 1, false, 'Скованные Набедренники Династии, дино, низ, ноги, хеви, heavy', null, 731 );
        seederAddRecipe( 'Moirai Gaiters', $imagePath, 40000000, 'S-80', $categoryId, 0, '60', 'Увеличивает Физ. Атк. на 2.08%<br>Увеличивает Скорость Атаки на 1%67<br>Увеличивает Защиту от Стана на 5<br>Увеличивает Защиту от Воды на 3', null, 1, false, 'Набедренники Дестино, морай, низ, ноги, хеви, heavy', null, 1010 );
        seederAddRecipe( 'Vesper Gaiters', $imagePath, 36000000, 'S-84', $categoryId, 0, '60', 'Увеличивает Физ. Атк. на 1.03%<br>Увеличивает Физ. Защ. на 1.03%<br>Увеличивает HP на 55<br>Увеличивает Защиту от Сна на 18<br>Увеличивает Защиту от Рута на 18', null, 1, false, 'Набедренники Венеры, веспер, низ, ноги, хеви, heavy', null, 1400 );
    }
    ...
    protected function addArmorHeavyHelmet() {
        ...
        seederAddRecipe( 'Imperial Crusader Helmet', $imagePath, 8000000, 'S', $categoryId, 0, '60', 'Увеличивает Физ. Защ. на 1.25%<br>Увеличивает HP на 111<br>Увеличивает Защиту от Сна на 10.5<br>Увеличивает Защиту от Рута на 10.5', null, 1, false, 'Шлем Имперского Крестоносца, ic, ик, шлем, каска, голова, хеви, heavy', null, 230 );
        seederAddRecipe( 'Dynasty Helmet', $imagePath, 14000000, 'S', $categoryId, 0, '60', 'Увеличивает Физ. Защ. на 1.25%<br>Увеличивает HP на 123<br>Увеличивает Защиту от Тьмы на 1.2', null, 1, false, 'Шлем Династии, дино, шлем, каска, голова, хеви, heavy', null, 439 );
        seederAddRecipe( 'Moirai Helmet', $imagePath, 250000000, 'S-80', $categoryId, 0, '60', 'Увеличивает Физ. Атк. на 1.25%<br>Увеличивает Скорость Атаки на 1%<br>Увеличивает Защиту от Стана на 5<br>Увеличивает Защиту от Огня на 3', null, 1, false, 'Шлем Дестино, дино, шлем, каска, голова, хеви, heavy', null, 606 );
        seederAddRecipe( 'Vesper Helmet', $imagePath, 40000000, 'S-84', $categoryId, 0, '60', 'Увеличивает Физ. Атк. на 0.62%<br>Увеличивает Физ. Защ. на 0.62%<br>Увеличивает HP на 133<br>Увеличивает Защиту от Сна на 1<br>Увеличивает Защиту от Рута на 1', null, 1, false, 'Шлем Венеры, веспер, шлем, каска, голова, хеви, heavy', null, 840 );
    }
    ...
    protected function addArmorHeavyBoot() {
        ...
        seederAddRecipe( 'Imperial Crusader Boots', $imagePath, 3000000, 'S', $categoryId, 0, '60', 'Увеличивает Физ. Защ. на 0.83%<br>Увеличивает HP на 74<br>Увеличивает Защиту от Сна на 7<br>Увеличивает Защиту от Рута на 7', null, 1, false, 'Сапоги Имперского Крестоносца, ic, ик, боты, сапоги, ботинки, хеви, heavy', null, 153 );
        seederAddRecipe( 'Dynasty Boots', $imagePath, 38000000, 'S', $categoryId, 0, '60', 'Увеличивает Физ. Защ. на 0.83%<br>Увеличивает HP на 82<br>Увеличивает Защиту от Тьмы на 0.8', null, 1, false, 'Сапоги Династии, дино, боты, сапоги, ботинки, хеви, heavy', null, 293 );
        seederAddRecipe( 'Moirai Boots', $imagePath, 20000000, 'S-80', $categoryId, 0, '60', 'Увеличивает Физ. Атк. на 0.83%<br>Увеличивает Скорость Атаки на 0.67%<br>Увеличивает Защиту от Стана на 5<br>Увеличивает Защиту от Земли на 3', null, 1, false, 'Сапоги Дестино, морай, боты, сапоги, ботинки, хеви, heavy', null, 404 );
        seederAddRecipe( 'Vesper Boots', $imagePath, 12000000, 'S-84', $categoryId, 0, '60', 'Увеличивает Физ. Атк. на 0.41%<br>Увеличивает Физ. Защ. на 0.41%<br>Увеличивает HP на 22<br>Увеличивает Защиту от Сна на 7<br>Увеличивает Защиту от Рута на 7', null, 1, false, 'Сапоги Венеры, веспер, боты, сапоги, ботинки, хеви, heavy', null, 560 );
    }
    ...
    protected function addArmorHeavyGloves() {
        ...
        seederAddRecipe( 'Imperial Crusader Gauntlets', $imagePath, 9500000, 'S', $categoryId, 0, '60', 'Увеличивает Физ. Защ. на 0.83%<br>Увеличивает HP на 74<br>Увеличивает Защиту от Сна на 7<br>Увеличивает Защиту от Рута на 7', null, 1, false, 'Рукавицы Имперского Крестоносца, ic, ик, перчатки, перчи, рукавицы, хеви, heavy', null, 153 );
        ...
        seederAddRecipe( 'Moirai Gauntlets', $imagePath, 15000000, 'S-80', $categoryId, 0, '60', 'Увеличивает Физ. Атк. на 0.83%<br>Увеличивает Скорость Атаки на 0.67%<br>Увеличивает Защиту от Стана на 5<br>Увеличивает Защиту от Воздуха на 3', null, 1, false, 'Рукавицы Дестино, морай, перчатки, перчи, рукавицы, хеви, heavy', null, 404 );
    ...
    protected function addArmorRobeFullBody() {
        ...
        seederAddRecipe( 'Avadon Robe', $imagePath, 3700000, 'B', $categoryId, 0, '60', 'Увеличивает Скорость Каста  на 15%<br>Увеличивает Маг. Защ.  на 17.08%', null, 1, false, 'Мантия Авадона, тело, роба, robe, маг', 6, 259, );
        seederAddRecipe( 'Avadon Robe 100%', $imagePath, 3700000, 'B', $categoryId, 0, '100', 'Увеличивает Скорость Каста  на 15%<br>Увеличивает Маг. Защ.  на 17.08%', null, 1, false, 'Мантия Авадона, тело, роба, robe, маг', 6, 259, );
        ...
        seederAddRecipe( 'Robe of Nightmare', $imagePath, 12000000, 'A', $categoryId, 0, '60', 'Увеличивает Маг. Атк. на 8.27%<br>Увеличивает Реген MP  на 8.27%<br>Увеличивает Защиту от Рута на 29.16<br>Увеличивает Защиту от Сна на 29.16', null, 1, false, 'Мантия Кошмаров, тело, роба, robe, маг', null, 528 );
    ...
    protected function addArmorRobeUpper() {
        ...
        seederAddRecipe( 'Tunic of Zubei', $imagePath, 2000000, 'B', $categoryId, 0, '60', 'Увеличивает Маг. Атк. на 15%', null, 1, false, 'Туника Зубея, зубей, верх, роба, маг, robe', 6, 160, );
        seederAddRecipe( 'Tunic of Zubei 100%', $imagePath, 2000000, 'B', $categoryId, 0, '100', 'Увеличивает Маг. Атк. на 15%', null, 1, false, 'Туника Зубея, зубей, верх, роба, маг, robe', 6, 160, );
        seederAddRecipe( 'Blue Wolf Tunic', $imagePath, 5500000, 'B', $categoryId, 0, '60', 'Увеличивает MP на 205<br>Увеличивает Реген MP на 7.24%', null, 1, false, 'Туника Синего Волка, бв, bw, верх, роба, маг, robe', null, 248 );
        seederAddRecipe( 'Blue Wolf Tunic 100%', $imagePath, 5500000, 'B', $categoryId, 0, '100', 'Увеличивает MP на 205<br>Увеличивает Реген MP на 7.24%', null, 1, false, 'Туника Синего Волка, бв, bw, верх, роба, маг, robe', null, 248 );
        seederAddRecipe( 'Tunic of Doom', $imagePath, 4500000, 'B', $categoryId, 0, '60', 'Увеличивает Объём Лёгких на 200<br>Увеличивает Реген MP на 7.24%<br>Увеличивает Скорость Бега на 7', null, 1, false, 'Туника Рока, дум, верх, роба, маг, robe', null, 248 );
        seederAddRecipe( 'Tunic of Doom 100%', $imagePath, 4500000, 'B', $categoryId, 0, '100', 'Увеличивает Объём Лёгких на 200<br>Увеличивает Реген MP на 7.24%<br>Увеличивает Скорость Бега на 7', null, 1, false, 'Туника Рока, дум, верх, роба, маг, robe', null, 248 );
        seederAddRecipe( 'Tallum Tunic', $imagePath, 4000000, 'A', $categoryId, 0, '60', 'Увеличивает Скорость Каста  на 15%', null, 1, false, 'Туника Таллума, верх, роба, маг, robe', 7, 214, );
        seederAddRecipe( 'Dynasty Tunic', $imagePath, 60000000, 'S', $categoryId, 0, '60', 'Увеличивает Скорость Каста  на 15%', null, 1, false, 'Туника Династии, дино, верх, роба, маг, robe', null, 878 );
        ...
        seederAddRecipe( 'Vesper Tunic', $imagePath, 111000000, 'S-84', $categoryId, 0, '60', 'Увеличивает Маг. Атк. на 8.47%<br>Увеличивает Скорость Каста  на 15%<br>Увеличивает Реген MP на 5%<br>Увеличивает Защиту от Стана на 20<br>Увеличивает Защиту от Кансела на 12', null, 1, false, 'Туника Венеры, веспер, верх, роба, маг, robe', null, 1680 );
    }
    ...
    protected function addArmorRobeLower() {
        ...
        seederAddRecipe( 'Stockings of Doom', $imagePath, 2000000, 'B', $categoryId, 0, '60', 'Увеличивает Скорость Бега на 2.91<br>Увеличивает Объём Лёгких на 88<br>Увеличивает Реген MP на 2.08%', null, 1, false, 'Штаны Рока, дум, низ, маг, роба', null, 100 );
        seederAddRecipe( 'Stockings of Doom 100%', $imagePath, 2000000, 'B', $categoryId, 0, '100', 'Увеличивает Скорость Бега на 2.91<br>Увеличивает Объём Лёгких на 88<br>Увеличивает Реген MP на 2.08%', null, 1, false, 'Штаны Рока, дум, низ, маг, роба', null, 100 );
        seederAddRecipe( 'Blue Wolf Stockings', $imagePath, 5800000, 'B', $categoryId, 0, '60', 'Увеличивает MP на 85<br>Увеличивает Реген MP на 2.08%', null, 1, false, 'Штаны Синего Волка, бв, bw, низ, маг, роба', null, 155 );
        seederAddRecipe( 'Blue Wolf Stockings 100%', $imagePath, 5800000, 'B', $categoryId, 0, '100', 'Увеличивает MP на 85<br>Увеличивает Реген MP на 2.08%', null, 1, false, 'Штаны Синего Волка, бв, bw, низ, маг, роба', null, 155 );
        ...
        seederAddRecipe( 'Tallum Stockings', $imagePath, 2800000, 'A', $categoryId, 0, '60', 'Увеличивает Маг. Защ. на 3.33%<br>Увеличивает Защиту от Отправления на 33.33<br>Увеличивает Защиту от Кровотечений на 33.33', null, 1, false, 'Штаны Таллума, низ, маг, роба', 7, 134, );
        seederAddRecipe( 'Dynasty Stockings', $imagePath, 28000000, 'S', $categoryId, 0, '60', 'Увеличивает Маг. Атк. на 2.08%<br>Увеличивает MP на 133<br>Увеличивает Защиту от Тьмы на 3.33', null, 1, false, 'Штаны Династии, дино, низ, маг, роба', null, 549 );
        seederAddRecipe( 'Moirai Stockings', $imagePath, 33000000, 'S-80', $categoryId, 0, '60', 'Увеличивает Маг. Атк. на 1.03%<br>Увеличивает Защиту от Паралича на 5<br>Увеличивает Защиту от Воды на 5', null, 1, false, 'Штаны Дестино, морай, низ, маг, роба', null, 758 );
        seederAddRecipe( 'Vesper Stockings', $imagePath, 60000000, 'S-84', $categoryId, 0, '60', 'Увеличивает Маг. Атк. на 0.68%<br>Увеличивает Реген MP на 0.68%<br>Увеличивает Защиту от Стана на 5<br>Увеличивает Защиту от Кансела на 7.5', null, 1, false, 'Штаны Венеры, веспер, низ, маг, роба', null, 1050 );
    }
    ...
    protected function addArmorRobeHelmet() {
        ...
        seederAddRecipe( 'Dynasty Circlet', $imagePath, 24000000, 'S', $categoryId, 0, '60', 'Увеличивает Маг. Атк. на 1.25%<br>Увеличивает MP на 80<br>Увеличивает Защиту от Тьмы на 2', null, 1, false, 'Диадема Династии, дино, шлем, каска, голова, маг, роба, robe', null, 439 );
        seederAddRecipe( 'Moirai Circlet', $imagePath, 217000000, 'S-80', $categoryId, 0, '60', 'Увеличивает Маг. Атк. на 0.62%<br>Увеличивает Защиту от Паралича на 5<br>Увеличивает Защиту от Огня на 5', null, 1, false, 'Диадема Дестино, морай, шлем, каска, голова, маг, роба, robe', null, 606 );
        seederAddRecipe( 'Vesper Circlet', $imagePath, 85000000, 'S-84', $categoryId, 0, '60', 'Увеличивает Маг. Атк. на 0.41%<br>Увеличивает Реген MP на 0.41%<br>Увеличивает Защиту от Стана на 8<br>Увеличивает Защиту от Кансела на 4.5', null, 1, false, 'Диадема Венеры, веспер, шлем, каска, голова, маг, роба, robe', null, 840 );
    }
    ...
    protected function addArmorRobeBoot() {
        ...
        seederAddRecipe( 'Dynasty Shoes', $imagePath, 20000000, 'S', $categoryId, 0, '60', 'Увеличивает Маг. Атк. на 0.83%<br>Увеличивает MP на 53<br>Увеличивает Защиту от Тьмы на 1.33', null, 1, false, 'Ботинки Династии, дино, боты, ботинки, сапоги, роба, robe, маг', null, 293 );
        seederAddRecipe( 'Moirai Shoes', $imagePath, 26000000, 'S-80', $categoryId, 0, '60', 'Увеличивает Маг. Атк. на 0.41%<br>Увеличивает Защиту от Паралича на 5<br>Увеличивает Защиту от Земли на 5', null, 1, false, 'Ботинки Дестино, морай, боты, ботинки, сапоги, роба, robe, маг', null, 404 );
        seederAddRecipe( 'Vesper Shoes', $imagePath, 40000000, 'S-84', $categoryId, 0, '60', 'Увеличивает Маг. Атк. на 0.27%<br>Увеличивает Реген MP на 0.27%<br>Увеличивает Защиту от Стана на 5<br>Увеличивает Защиту от Кансела на 3', null, 1, false, 'Ботинки Венеры, боты, ботинки, сапоги, роба, robe, маг', null, 560 );
    }
    ...
    protected function addArmorRobeGloves() {
        ...
        seederAddRecipe( 'Dynasty Gloves', $imagePath, 39000000, 'S', $categoryId, 0, '60', 'Увеличивает Маг. Атк. на 0.83%<br>Увеличивает MP на 53<br>Увеличивает Защиту от Тьмы на 1.33', null, 1, false, 'Перчатки Династии, дино, перчатки, перчи, рукавицы, маг, robe, роба', null, 293 );
        ...
        seederAddRecipe( 'Vesper Gloves', $imagePath, 30000000, 'S-84', $categoryId, 0, '60', 'Увеличивает Маг. Атк. на 0.27%<br>Увеличивает Реген MP на 0.27%<br>Увеличивает Защиту от Стана на 5<br>Увеличивает Защиту от Кансела на 3', null, 1, false, 'Перчатки Венеры, веспер, перчатки, перчи, рукавицы, маг, robe, роба', null, 560 );
    }
    ...
    protected function addArmorUniversalHelmet() {
        ...
        seederAddRecipe( 'Avadon Circlet', $imagePath, 7500000, 'B', $categoryId, 0, '60', '<b>Heavy</b>:<br>Увеличивает HP на 73<br><b>Light</b>:<br>Увеличивает Маг. Защ. на 1%25<br>Увеличивает Грузоподъёмность на 1440<br><b>Robe</b>:<br>Увеличивает Физ. Защ. на 1.25%', null, 1, false, 'Диадема Авадона, шлем, каска, голова', 6, 80, );
        seederAddRecipe( 'Avadon Circlet 100%', $imagePath, 7500000, 'B', $categoryId, 0, '100', '<b>Heavy</b>:<br>Увеличивает HP на 73<br><b>Light</b>:<br>Увеличивает Маг. Защ. на 1%25<br>Увеличивает Грузоподъёмность на 1440<br><b>Robe</b>:<br>Увеличивает Физ. Защ. на 1.25%', null, 1, false, 'Диадема Авадона, шлем, каска, голова', 6, 80, );
        seederAddRecipe( 'Zubei\'s Helmet', $imagePath, 1600000, 'B', $categoryId, 0, '60', '<b>Heavy</b>:<br>Увеличивает Физ. Защ. на 1.25%<br>Увеличивает HP на 74<br><b>Light</b>:<br>Увеличивает Уклонение на 0.88<br><b>Robe</b>:<br>Увеличивает Маг. Атк. на 1.25%', null, 1, false, 'Шлем Зубея, зубей, шлем, каска, голова', 6, 80, );
        seederAddRecipe( 'Zubei\'s Helmet 100%', $imagePath, 1600000, 'B', $categoryId, 0, '100', '<b>Heavy</b>:<br>Увеличивает Физ. Защ. на 1.25%<br>Увеличивает HP на 74<br><b>Light</b>:<br>Увеличивает Уклонение на 0.88<br><b>Robe</b>:<br>Увеличивает Маг. Атк. на 1.25%', null, 1, false, 'Шлем Зубея, зубей, шлем, каска, голова', 6, 80, );
        ...
        seederAddRecipe( 'Dark Crystal Helmet', $imagePath, 13000000, 'A', $categoryId, 0, '60', '<b>Heavy</b>:<br>Увеличивает Эффективность магии, восстанавливающей HP самому себе на 1%<br>Увеличивает Защиту от Паралича на 7.5<br><b>Light</b>:<br>Увеличивает Скорость Атаки на 0.62%<br>Увеличивает Физ. Атк. на 0.62%<br>Увеличивает Защиту от Паралича на 7.5<br><b>Robe</b>:<br>Увеличивает Физ. Защ. на 2%<br>Увеличивает Скорость Бега на 1.75<br>Увеличивает Защиту от Кансела на 13<br>Увеличивает Защиту от Паралича на 12.5', null, 1, false, 'Шлем Кристалла Тьмы, дк, dc, шлем, каска, голова', 7, 107, );
        ...
        seederAddRecipe( 'Helm of Nightmare', $imagePath, 15000000, 'A', $categoryId, 0, '60', '<b>Heavy</b>:<br>Увеличивает Физ. Атк. на 1.25%<br>Увеличивает Защиту от Сна на 17.5<br>Увеличивает Защиту от Рута на 17.5<br><b>Light</b>:<br>Увеличивает Маг. Защ. на 0.62%<br>Увеличивает Защиту от Сна на 17.5<br>Увеличивает Защиту от Рута на 17.5<br><b>Robe</b>:<br>Увеличивает Реген MP на 0.62%<br>Увеличивает Маг. Атк. на 0.62%<br>Увеличивает Защиту от Сна на 17.5<br>Увеличивает Защиту от Рута на 17.5', null, 1, false, 'Шлем Кошмаров, шлем, каска, голова', null, 163 );
    ...
    protected function addArmorUniversalBoot() {
        ...
        seederAddRecipe( 'Zubei\'s Boots', $imagePath, 4000000, 'B', $categoryId, 0, '60', '<b>Heavy</b>:<br>Увеличивает Физ. Защ. на 0.83%<br>Увеличивает HP на 49<br><b>Light</b>:<br>Увеличивает Уклонение на 0.59<br><b>Robe</b>:<br>Увеличивает Маг. Атк. на 0.83%', null, 1, false, 'Сапоги Зубея, зубей, боты, сапоги, ботинки', 6, 53, );
        seederAddRecipe( 'Zubei\'s Boots 100%', $imagePath, 4000000, 'B', $categoryId, 0, '100', '<b>Heavy</b>:<br>Увеличивает Физ. Защ. на 0.83%<br>Увеличивает HP на 49<br><b>Light</b>:<br>Увеличивает Уклонение на 0.59<br><b>Robe</b>:<br>Увеличивает Маг. Атк. на 0.83%', null, 1, false, 'Сапоги Зубея, зубей, боты, сапоги, ботинки', 6, 53, );
    ...
    protected function addArmorUniversalGloves() {
        ...
        seederAddRecipe( 'Avadon Gloves', $imagePath, 2300000, 'B', $categoryId, 0, '60', '<b>Heavy</b>:<br>Увеличивает HP на 49<br><b>Light</b>:<br>Увеличивает Маг. Защ. на 0.83%<br>Увеличивает Грузоподъёмность на 960<br><b>Robe</b>:<br>Увеличивает Физ. Защ. на 0.83%', null, 1, false, 'Перчатки Авадона, перчатки, перчи, рукавицы', 6, 53, );
        seederAddRecipe( 'Avadon Gloves 100%', $imagePath, 2300000, 'B', $categoryId, 0, '100', '<b>Heavy</b>:<br>Увеличивает HP на 49<br><b>Light</b>:<br>Увеличивает Маг. Защ. на 0.83%<br>Увеличивает Грузоподъёмность на 960<br><b>Robe</b>:<br>Увеличивает Физ. Защ. на 0.83%', null, 1, false, 'Перчатки Авадона, перчатки, перчи, рукавицы', 6, 53, );
