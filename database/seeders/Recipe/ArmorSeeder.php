...
class ArmorSeeder extends Seeder {
    ...
    protected function addShield() {
        ...
        seederAddRecipe( 'Zubei\'s Shield', $imagePath, 0, 'B', $categoryId, 0, '60', 'Multiplies M.Def by 1.02' );
        seederAddRecipe( 'Zubei\'s Shield 100%', $imagePath, 0, 'B', $categoryId, 0, '100', 'Multiplies M.Def by 1.02' );
        ...
        seederAddRecipe( 'Doom Shield', $imagePath, 0, 'B', $categoryId, 0, '60', 'Multiplies M.Def by 1.02' );
        seederAddRecipe( 'Doom Shield 100%', $imagePath, 0, 'B', $categoryId, 0, '100', 'Multiplies M.Def by 1.02' );
        seederAddRecipe( 'Dark Crystal Shield', $imagePath, 0, 'A', $categoryId, 0, '60', 'Multiplies M.Def by 1.02' );
        seederAddRecipe( 'Shield of Nightmare', $imagePath, 0, 'A', $categoryId, 0, '60', 'Multiplies M.Def by 1.02' );
    ...
    protected function addArmorUniversalGloves() {
        ...
        seederAddRecipe( 'Majestic Gauntlets', $imagePath, 0, 'A', $categoryId, 0, '60', 'Heavy:<br>Multiplies P.Atk by 1.0041<br>Adds Accuracy Combat by 0.31<br>Decreases Stun Vulnerability by 8.33<br>Light:<br>Multiplies P.Atk by 1.0083<br>Adds Max MP by 40<br>Adds Max Load by 960<br>Decreases Stun Vulnerability by 8.33<br>Robe:<br>Adds Max MP by 40<br>Multiplies Regen MP by 1.0133<br>Decreases Stun Vulnerability by 8.33' );
        seederAddRecipe( 'Gauntlets of Nightmare', $imagePath, 0, 'A', $categoryId, 0, '60', 'Heavy:<br>Multiplies P.Atk by 1.0083<br>Decreases Sleep Vulnerability by 11.66<br>Decreases Root Vulnerability by 11.66<br>Light:<br>Multiplies P.Atk by 1.0041<br>Decreases Sleep Vulnerability by 11.66<br>Decreases Root Vulnerability by 11.66<br>Robe:<br>Multiplies Regen MP by 1.0041<br>Multiplies M.Atk by 1.0041<br>Decreases Sleep Vulnerability by 11.66<br>Decreases Root Vulnerability by 11.66' );
        seederAddRecipe( 'Tallum Gloves', $imagePath, 0, 'A', $categoryId, 0, '60', 'Heavy:<br>Multiplies P.Atk Speed by 1.0083<br>Adds Max Load by 960<br>Decreases Poison Vulnerability by 8<br>Decreases Bleed Vulnerability by 8<br>Light:<br>Multiplies Regen MP by 1.0083<br>Adds Max MP by 37<br>Decreases Poison Vulnerability by 8<br>Decreases Bleed Vulnerability by 8<br>Robe:<br>Multiplies M.Def by 1.0133<br>Decreases Poison Vulnerability by 13.33<br>Decreases Bleed Vulnerability by 13.33' );
        seederAddRecipe( 'Dark Crystal Gloves', $imagePath, 0, 'A', $categoryId, 0, '60', 'Heavy:<br>Multiplies Gain Hp by 1.01<br>Decreases Paralyze Vulnerability by 5<br>Light:<br>Multiplies P.Atk Speed by 1.0041<br>Multiplies P.Atk by 1.0041<br>Decreases Paralyze Vulnerability by 5<br>Robe:<br>Multiplies P.Def by 1.0133<br>Adds Run Speed by 1.16<br>Decreases Cancel by 8<br>Decreases Paralyze Vulnerability by 8.33' );
    }
