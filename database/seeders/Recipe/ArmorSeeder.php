...
class ArmorSeeder extends Seeder {
    ...
    protected function addArmorHeavyFullBody() {
        ...
        seederAddRecipe( 'Compound Armor', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, 'компот, тело, heavy, хеви', 5 );
        seederAddRecipe( 'Full Plate Armor', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, 'фп, тело, heavy, хеви', 6 );
    ...
    protected function addArmorRobeUpper() {
        ...
        seederAddRecipe( 'Karmian Tunic', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, 'кармиан, верх, роба, маг, robe', 4 );
        seederAddRecipe( 'Demon\'s Tunic', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, 'верх, роба, маг, robe', 5 );
        seederAddRecipe( 'Divine Tunic', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, 'верх, роба, маг, robe', 6 );
    ...
    protected function addArmorRobeLower() {
        ...
        seederAddRecipe( 'Karmian Stockings', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, 'кармиан, низ, маг, роба', 4 );
        seederAddRecipe( 'Demon\'s Stockings', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, 'низ, маг, роба', 5 );
        seederAddRecipe( 'Divine Stockings', $imagePath, 0, 'C', $categoryId, 0, '100', null, null, 1, false, 'низ, маг, роба', 6 );
