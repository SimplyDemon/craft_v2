...
class JewelrySeeder extends Seeder {
    ...
    protected function addJewelryNecklace() {
        ...
        seederAddRecipe( 'Adamantite Necklace', $imagePath, 1800000, 'B', $categoryId, 0, '70', 'Увеличивает Сопротивление к Стану на 3.57', null, 1, false, 'Адамантитовое Ожерелье, некля, шея, necklace, ожерелье', 6, 83, );
        seederAddRecipe( 'Adamantite Necklace 100%', $imagePath, 1800000, 'B', $categoryId, 0, '100', 'Увеличивает Сопротивление к Стану на 3.57', null, 1, false, 'Адамантитовое Ожерелье, некля, шея, necklace, ожерелье', 6, 83, );
        seederAddRecipe( 'Black Ore Necklace', $imagePath, 2000000, 'B', $categoryId, 0, '70', 'Увеличивает Сопротивление к Стану на 4.76', null, 1, false, 'Черное Ожерелье, bo, бо, некля, шея, necklace, ожерелье', 126, );
        seederAddRecipe( 'Black Ore Necklace 100%', $imagePath, 2000000, 'B', $categoryId, 0, '100', 'Увеличивает Сопротивление к Стану на 4.76', null, 1, false, 'Черное Ожерелье, bo, бо, некля, шея, necklace, ожерелье', 126, );
        ...
        seederAddRecipe( 'Tateossian Necklace', $imagePath, 8000000, 'S', $categoryId, 0, '70', 'Увеличивает Защиту от Кровотечений на 7.61', null, 1, false, 'Ожерелье Татеосса, тт, tt, некля, шея, necklace, ожерелье', null, 209 );
        ...
        seederAddRecipe( 'Vesper Necklace', $imagePath, 15000000, 'S-84', $categoryId, 0, '70', 'Увеличивает MP на 33', null, 1, false, 'Ожерелье Венеры, веспер, некля, шея, necklace, ожерелье', null, 494 );
    }
    ...
    protected function addJewelryEarring() {
        ...
        seederAddRecipe( 'Adamantite Earring', $imagePath, 800000, 'B', $categoryId, 0, '70', 'Увеличивает MP на 17', null, 1, false, 'Адамантитовая Серьга', 6, 62, );
        seederAddRecipe( 'Adamantite Earring 100%', $imagePath, 800000, 'B', $categoryId, 0, '100', 'Увеличивает MP на 17', null, 1, false, 'Адамантитовая Серьга', 6, 62, );
        seederAddRecipe( 'Black Ore Earring', $imagePath, 1200000, 'B', $categoryId, 0, '70', 'Увеличивает Защиту от Тьмы на 1.71', null, 1, false, 'Черная Серьга, бо, bo', null, 95 );
        seederAddRecipe( 'Black Ore Earring 100%', $imagePath, 1200000, 'B', $categoryId, 0, '100', 'Увеличивает Защиту от Тьмы на 1.71', null, 1, false, 'Черная Серьга, бо, bo', null, 95 );
        seederAddRecipe( 'Phoenix Earring', $imagePath, 0, 'A', $categoryId, 0, '70', 'Увеличивает Маг. Защ. на 1%', null, 1, false, 'Серьга Феникса', 7, 80, );
        seederAddRecipe( 'Majestic Earring', $imagePath, 5500000, 'A', $categoryId, 0, '70', 'Увеличивает Защиту от Отправления на 5.71', null, 1, false, 'Серьга Величия, мж, mj', null, 104 );
        seederAddRecipe( 'Tateossian Earring', $imagePath, 10000000, 'S', $categoryId, 0, '70', 'Увеличивает MP на 20', null, 1, false, 'Серьга Татеосса, тт, tt', null, 157 );
        ...
        seederAddRecipe( 'Moirai Earring', $imagePath, 27000000, 'S-80', $categoryId, 0, '70', 'Увеличивает Защиту от Кровотечений на 7.62', null, 1, false, 'Серьга Дестино, moirai, морай', null, 267 );
        seederAddRecipe( 'Vesper Earring', $imagePath, 10000000, 'S-84', $categoryId, 0, '70', 'Увеличивает Защиту от Сна на 5<br>Увеличивает Защиту от Рута на 5', null, 1, false, 'Серьга Венеры, веспер', null, 370 );
    }
    ...
    protected function addJewelryRing() {
        ...
        seederAddRecipe( 'Adamantite Ring', $imagePath, 650000, 'B', $categoryId, 0, '70', 'Увеличивает Реген MP на 0.71%', null, 1, false, 'Адамантитовое Кольцо', 6, 41, );
        seederAddRecipe( 'Adamantite Ring 100%', $imagePath, 650000, 'B', $categoryId, 0, '100', 'Увеличивает Реген MP на 0.71%', null, 1, false, 'Адамантитовое Кольцо', 6, 41, );
        seederAddRecipe( 'Black Ore Ring', $imagePath, 1000000, 'B', $categoryId, 0, '70', 'Увеличивает MP на 9', null, 1, false, 'Черное Кольцо, бо, bo', null, 63 );
        seederAddRecipe( 'Black Ore Ring 100%', $imagePath, 1000000, 'B', $categoryId, 0, '100', 'Увеличивает MP на 9', null, 1, false, 'Черное Кольцо, бо, bo', null, 63 );
        seederAddRecipe( 'Phoenix Ring', $imagePath, 3000000, 'A', $categoryId, 0, '70', 'Увеличивает Реген MP на 0.71%', null, 1, false, 'Кольцо Феникса', 7, 54, );
        ...
        seederAddRecipe( 'Tateossian Ring', $imagePath, 8000000, 'S', $categoryId, 0, '70', 'Увеличивает Защиту от Земли на 1.14', null, 1, false, 'Кольцо Татеосса, тт, tt', null, 105 );
        ...
        seederAddRecipe( 'Vesper Ring', $imagePath, 6000000, 'S-84', $categoryId, 0, '70', 'Увеличивает Сопротивление к Стану на 4.76', null, 1, false, 'Кольцо Венеры, веспер', null, 247 );
    }
}
