...
class JewelrySeeder extends Seeder {
    ...
    protected function addJewelryNecklace() {
        ...
        seederAddRecipe( 'Adamantite Necklace', $imagePath, 1800000, 'B', $categoryId, 0, '70', 'Decreases Stun Vulnerability by 3.57' );
        seederAddRecipe( 'Adamantite Necklace 100%', $imagePath, 1800000, 'B', $categoryId, 0, '100', 'Decreases Stun Vulnerability by 3.57' );
        seederAddRecipe( 'Black Ore Necklace', $imagePath, 2000000, 'B', $categoryId, 0, '70', 'Decreases Stun Vulnerability by 4.76' );
        seederAddRecipe( 'Black Ore Necklace 100%', $imagePath, 2000000, 'B', $categoryId, 0, '100', 'Decreases Stun Vulnerability by 4.76' );
        ...
        seederAddRecipe( 'Vesper Necklace', $imagePath, 15000000, 'S-84', $categoryId, 0, '70', 'Adds Max MP by 33' );
    }
    ...
    protected function addJewelryEarring() {
        ...
        seederAddRecipe( 'Adamantite Earring', $imagePath, 800000, 'B', $categoryId, 0, '70', 'Adds Max MP by 17' );
        seederAddRecipe( 'Adamantite Earring 100%', $imagePath, 800000, 'B', $categoryId, 0, '100', 'Adds Max MP by 17' );
        seederAddRecipe( 'Black Ore Earring', $imagePath, 1200000, 'B', $categoryId, 0, '70', 'Adds Dark Resistance by 1.71' );
        seederAddRecipe( 'Black Ore Earring 100%', $imagePath, 1200000, 'B', $categoryId, 0, '100', 'Adds Dark Resistance by 1.71' );
        seederAddRecipe( 'Phoenix Earring', $imagePath, 0, 'A', $categoryId, 0, '70', 'Multiplies M.Def by 1.01' );
        seederAddRecipe( 'Majestic Earring', $imagePath, 5500000, 'A', $categoryId, 0, '70', 'Decreases Poison Vulnerability by 5.71' );
        ...
        seederAddRecipe( 'Moirai Earring', $imagePath, 27000000, 'S-80', $categoryId, 0, '70', 'Decreases Bleed Vulnerability by 7.62' );
        seederAddRecipe( 'Vesper Earring', $imagePath, 10000000, 'S-84', $categoryId, 0, '70', 'Decreases Sleep Vulnerability by 5<br>Decreases Root Vulnerability by 5' );
    }
    ...
    protected function addJewelryRing() {
        ...
        seederAddRecipe( 'Adamantite Ring', $imagePath, 650000, 'B', $categoryId, 0, '70', 'Multiplies Regen MP by 1.0071' );
        seederAddRecipe( 'Adamantite Ring 100%', $imagePath, 650000, 'B', $categoryId, 0, '100', 'Multiplies Regen MP by 1.0071' );
        seederAddRecipe( 'Black Ore Ring', $imagePath, 1000000, 'B', $categoryId, 0, '70', 'Adds Max MP by 9' );
        seederAddRecipe( 'Black Ore Ring 100%', $imagePath, 1000000, 'B', $categoryId, 0, '100', 'Adds Max MP by 9' );
        seederAddRecipe( 'Phoenix Ring', $imagePath, 3000000, 'A', $categoryId, 0, '70', 'Multiplies Regen MP by 1.0071' );
        seederAddRecipe( 'Majestic Ring', $imagePath, 0, 'A', $categoryId, 0, '70', 'Adds Max MP by 11' );
        seederAddRecipe( 'Tateossian Ring', $imagePath, 8000000, 'S', $categoryId, 0, '70', 'Adds Earth Resistance by 1.14' );
